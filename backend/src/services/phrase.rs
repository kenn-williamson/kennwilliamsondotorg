...
impl PhraseService {
    ...
    pub async fn approve_suggestion(
        ...
        sqlx::query!(
            ...
            SET status = 'approved', admin_id = $2, admin_reason = $3, updated_at = NOW()
            WHERE id = $1
            "#,
            suggestion_id,
            admin_id,
        ...
        // Then, create the phrase from the suggestion
        sqlx::query!(
            r#"
            INSERT INTO phrases (phrase_text, active, created_by)
            SELECT phrase_text, true, user_id
            FROM phrase_suggestions
            WHERE id = $1
            "#,
            suggestion_id
    ...
    pub async fn reject_suggestion(
        ...
        sqlx::query!(
            r#"
            UPDATE phrase_suggestions 
            SET status = 'rejected', admin_id = $2, admin_reason = $3, updated_at = NOW()
            WHERE id = $1
            "#,
            suggestion_id,
            admin_id,
