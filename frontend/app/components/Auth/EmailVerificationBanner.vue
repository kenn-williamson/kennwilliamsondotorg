<template>
  <div
    ...
    class="bg-gold-50 border-l-4 border-gold-400 p-4"
  >
    <div class="flex items-center justify-between">
      <div class="flex items-center flex-1">
        <!-- Warning Icon -->
        <div class="flex-shrink-0">
          <svg class="h-5 w-5 text-gold-400" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="flex-shrink-0 ml-4">
          <button
            ...
            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gold-700 bg-gold-100 hover:bg-gold-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
          >
      ...
      <div class="ml-4 flex-shrink-0">
        <button
          @click="dismissBanner"
          class="inline-flex text-gold-400 hover:text-gold-500 focus:outline-none focus:text-gold-500 transition-colors duration-200"
        >
