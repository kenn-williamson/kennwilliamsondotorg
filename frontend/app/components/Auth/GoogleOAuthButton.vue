<template>
  ...
  >
    ...
    <!-- Loading Spinner -->
    <svg v-else class="animate-spin w-5 h-5 text-current" fill="none" viewBox="0 0 24 24">
...
const buttonClasses = computed(() => [
  ...
  'border border-nautical-300 rounded-md',
  'bg-white hover:bg-nautical-50',
  'text-nautical-700 font-medium text-sm',
