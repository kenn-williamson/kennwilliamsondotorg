  ...
  <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-sky-50 to-blue-50">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-nautical-900 mb-2">Create Account</h1>
        <p class="text-nautical-600">Join the digital sanctuary</p>
      </div>
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg border border-sky-200 p-8">
        ...
        <form @submit.prevent="onSubmit" class="space-y-6">
          ...
          <!-- Display Name Field -->
          <div>
            <label for="displayName" class="block text-sm font-medium text-nautical-700 mb-2">
              Display Name
              <span class="text-xs text-nautical-500 ml-1">(how you want to be called)</span>
            </label>
            <Field
              name="displayName"
              type="text"
            ...
            <div v-if="slugPreview && (values.displayName?.length || 0) >= 2" class="mt-2 p-3 bg-sky-50 border border-sky-200 rounded-md">
              ...
              <div v-if="!slugPreview.available" class="flex items-center text-xs text-gold-600">
