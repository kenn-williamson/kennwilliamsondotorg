  ...
  <div class="min-h-screen mahogany-background px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="prose prose-lg max-w-none steampunk-prose">
          ...
          <section class="mb-8">
            ...
            <ul class="list-disc pl-6 text-nautical-700 space-y-2">
              ...
              <li>Attempt to hack, exploit, or compromise the site's security</li>
              <li>Scrape, crawl, or automatically collect data from the site without permission</li>
              <li>Use the site to distribute viruses, malware, or other malicious code</li>
              <li>Impersonate other people or misrepresent your affiliation with anyone</li>
          ...
          <section class="mb-8">
            ...
            <p class="text-nautical-700 leading-relaxed">
              ...
              example, if you're actively attacking the site or other users).
            </p>
          </section>
          ...
          <section>
            <div class="bg-gold-50 border-l-4 border-gold-500 p-6 rounded-r-lg">
              <p class="text-nautical-700 leading-relaxed">
                ...
                get along fine. If you have questions or concerns, I'm a real person and you can
                actually reach me. I'll respond honestly and try to work things out reasonably.
              </p>
            </div>
          </section>
      ...
      <div class="mt-8 text-center space-x-6">
        <NuxtLink to="/privacy" class="steampunk-link">
          Privacy Policy
        </NuxtLink>
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Terms of Service for KennWilliamson.org - the rules and expectations for using this site.' }
  ]
})
</script>
